...
public class QuizController {
	...
	public String insert(@Validated QuizForm quizForm, BindingResult bindingResult,
		...
		quiz.setAnswer(quizForm.isAnswer());
	...
	@GetMapping("/{id}")
	public String showUpdate(QuizForm quizForm, @PathVariable(name="id") Integer id, Model model) {
	...
	@PostMapping("/check")
	public String checkQuiz(QuizForm quizForm, @RequestParam(name="answer") Boolean answer,
								Model model) {
